...
use App\Models\Jagomart\OperationalTime;
    ...
    public function getOperationalTime(){
        try{
            ...
            $data = Day::select($select)
                ->leftJoin('jagomart.operational_time',function($join) use ($outlet){
